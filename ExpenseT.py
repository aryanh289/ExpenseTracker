...
def amount():
    ...
    dateLabel=Label(root,text="Total Expences",font=('arial',15,'bold'),bg="Red",fg="white",width=18)
    dateLabel.grid(row=8,column=0,padx=2,pady=7)
    dateLabel=Label(root,text=amount,font=('arial',15,'bold'),bg="Black",fg="white",width=12)
    dateLabel.grid(row=8,column=1,padx=2,pady=7)
...
init()
root=Tk()
root.title("Expense Tracker Project")
...
Name=StringVar()
nameLabel=Label(root, text="Name",font=('arial',15,'bold'),bg="Red",fg="white",width=12)
...
Expense=IntVar()
expenseLabel=Label(root,text="Expense",font=('arial',15,'bold'),bg="Green",fg="white",width=12)
...
submitbtn=Button(root,command=submitexpense,text="Submit",font=('arial',15,'bold'),bg="DodgerBlue2",fg="red",width=12 )
submitbtn.grid(row=4,column=0,padx=13,pady=13)

viewtn=Button(root,command=viewexpense,text="View expenses",font=('arial',15,'bold'),bg="DodgerBlue2",fg="red",width=22 )
viewtn.grid(row=4,column=1,padx=13,pady=13)

viewtn=Button(root,command=amount,text="Total",font=('arial',15,'bold'),bg="DodgerBlue2",fg="red",width=22 )
...
Etable.grid(row=5,column=0,padx=20,pady=7,columnspan=3)
